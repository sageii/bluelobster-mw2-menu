...
{	
	...
	if ( !isDefined( game["gamestarted"] ) )
	{
		...
		game["menu_cac"] = "cacingame";
		game["menu_main"] = "cacmain";
		game["menu_hostmigration"] = "hostmigration";
		...
		precacheMenu(game["menu_cac"]);
		//precacheMenu(game["menu_design"]);
		precacheMenu(game["menu_main"]);
		//precacheMenu(game["menu_primary_sub"]);
